...
public class barPlotVerticalScript : MonoBehaviour
{
    ...
    public void setFullscreen()
    {
        if (fullscreen)
        {
            canvas.offsetMin = new Vector2(50, 70); //left, bottom
            canvas.offsetMax = new Vector2(-50, -50); //-right, -top
        ...
        {
            canvas.offsetMin = new Vector2(100, 100);
            canvas.offsetMax = new Vector2(-50, 50);
